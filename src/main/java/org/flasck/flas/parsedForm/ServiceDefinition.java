...
public class ServiceDefinition implements Locatable, ServiceElementsConsumer {
	...
	public ServiceDefinition(ErrorReporter errors, InputPosition kw, InputPosition location, CardName name) {
		this.kw = kw;
