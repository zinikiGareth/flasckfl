...
public interface RepositoryVisitor {
	...
	void visitUnitTestIdentical(UnitTestIdentical a);
	void postUnitTestIdentical(UnitTestIdentical a);
	...
	void visitUnitTestExpectCancel(UnitTestExpectCancel utec);
	void expectHandlerNext();
	void leaveUnitTestExpect(UnitTestExpect ute);
	void leaveUnitTestExpectCancel(UnitTestExpectCancel utec);
	...
	void visitUnitTestInput(UnitTestInput e);
	...
	void leaveCardAssignment(CardBinding card);
	void visitActions(RoutingActions actions);
