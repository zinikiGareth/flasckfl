...
public class RWStructDefn extends TypeWithNameAndPolys implements AsString, ExternalRef {
	...
	public final FieldsType ty;

	public RWStructDefn(InputPosition location, FieldsType ty, SolidName tn, boolean generate, PolyVar... polys) {
		this(location, ty, tn, generate, Arrays.asList(polys));
	}
	
	public RWStructDefn(InputPosition location, FieldsType ty, SolidName tn, boolean generate, List<PolyVar> polys) {
