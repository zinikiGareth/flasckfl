...
EnterEvent.prototype.dispatch = function(_cxt) {
  ...
  } else if (this.cnt == this.actions.length && !this.div || this.cnt == this.actions.length + 1 && this.div) {
    if (this.andThenMsg)
...
var proxy2 = function(cx2, intf, handler) {
...
var MarshallerProxy = function(logger, ctr, svc) {
  this.logger = logger;
  this.svc = svc;
  this.proxy = proxy2(logger, ctr, this);
};
...
ObjectMarshaller.prototype.recursiveMarshal = function(cx2, ux, o) {
  if (o._throw && o._throw()) {
    ...
    if (o instanceof IdempotentHandler) {
      ...
      var h = new NamedIdempotentHandler(proxy2(cx2, intf, this.makeHandlerInvoker(cx2, ihid)));
      h._ihid = ihid;
      ux.handler(cx2, h);
...
Send2.prototype.dispatch = function(cx2) {
  ...
  if (this.obj instanceof ResponseWithMessages) {
    ...
    ret3.push(Send2.eval(cx2, ResponseWithMessages.response(cx2, this.obj), this.meth, this.args, this.handle));
    return ret3;
  }
...
import { NamedIdempotentHandler as NamedIdempotentHandler2 } from "/js/ziwsh.js";
