...
test.golden._Webzip.B1 = function(parent) {
  ...
  var b5_parent = new DivArea(parent, null, null, null, this._doc.getElementById(listitems_id));
  var b5 = new test.golden._Webzip.B5(b5_parent);
}
...
test.golden._Webzip.B4 = function(parent) {
  TextArea.call(this, parent);
  if (!parent) return;
  this._onAssign(this._card, 'name', test.golden._Webzip.B4.prototype._contentExpr);
  test.golden._Webzip.B4.prototype._contentExpr.call(this);
}
...
test.golden._Webzip.B4.prototype._contentExpr = function() {
...
test.golden._Webzip.B5 = function(parent) {
  DivArea.call(this, parent);
  if (!parent) return;
  var b6 = new test.golden._Webzip.B6(this);
}

test.golden._Webzip.B5.prototype = new DivArea();
...
test.golden._Webzip.B6 = function(parent) {
  ...
  if (!parent) return;
  test.golden._Webzip.B6.prototype._assignToVar.call(this);
  this._onAssign(this._card, 'list', test.golden._Webzip.B6.prototype._assignToVar);
}

test.golden._Webzip.B6.prototype = new ListArea();

test.golden._Webzip.B6.prototype.constructor = test.golden._Webzip.B6;

test.golden._Webzip.B6.prototype._newChild = function() {
  return new test.golden._Webzip.B7(this);
}
...
test.golden._Webzip.B7 = function(parent) {
  ...
  if (!parent) return;
  this._src_e = this;
  var b8 = new test.golden._Webzip.B8(this);
}

test.golden._Webzip.B7.prototype = new DivArea();

test.golden._Webzip.B7.prototype.constructor = test.golden._Webzip.B7;

test.golden._Webzip.B7.prototype._assignToVar = function(obj) {
...
test.golden._Webzip.B8 = function(parent) {
  ...
  this._src_e._interested(this, test.golden._Webzip.B8.prototype._contentExpr);
  test.golden._Webzip.B8.prototype._contentExpr.call(this);
}

test.golden._Webzip.B8.prototype = new TextArea();

test.golden._Webzip.B8.prototype.constructor = test.golden._Webzip.B8;

test.golden._Webzip.B8.prototype._contentExpr = function() {
  this._assignToText(this.contents_2());
}

test.golden._Webzip.B6.prototype._assignToVar = function() {
  var lv = FLEval.full(this.lvs_1());
  ListArea.prototype._assignToVar.call(this, lv);
}

test.golden._Webzip.B4.prototype.contents_0 = function() {
  "use strict";
  return this._card.name;
}

test.golden._Webzip.B6.prototype.lvs_1 = function() {
  "use strict";
  return this._card.list;
}

test.golden._Webzip.B8.prototype.contents_2 = function() {
  "use strict";
  return this._src_e.e;
}
