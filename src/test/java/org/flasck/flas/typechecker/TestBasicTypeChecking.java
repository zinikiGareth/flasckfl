...
public class TestBasicTypeChecking {
	...
	protected void fntype(ImportPackage pkg, String name, Type... types) {
		RWFunctionDefinition fn = new RWFunctionDefinition(posn, CodeType.FUNCTION, FunctionName.function(posn, CodeType.FUNCTION, null, name), types.length-1, null, false);
