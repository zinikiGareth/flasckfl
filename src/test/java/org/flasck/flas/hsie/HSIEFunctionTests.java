...
public class HSIEFunctionTests {
	...
	public void testConvertingFib() {
		...
		FunctionDefinition fib = new FunctionDefinition(1, CollectionUtils.listOf(c1, c2, c3));
	...
	public void testConvertingTake() {
		...
		FunctionDefinition take = new FunctionDefinition(2, CollectionUtils.listOf(c1, c2, c3));
