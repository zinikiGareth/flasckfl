...
public class FunctionParsingTests {
	...
	public void testParsingFibBlock1() {
		...
		ParsedFormTestData.assertFormsEqual(ParsedFormTestData.fibDefn1(), new FunctionParser().tryParsing(new Tokenizable(b)));
	}
	...
	public void testParsingFibBlock2() {
		...
		BlockerTests.showBlock(0, b);
		ParsedFormTestData.assertFormsEqual(ParsedFormTestData.fibDefn2(), new FunctionParser().tryParsing(new Tokenizable(b)));
	}
	...
	public void testParsingFibBlockN() {
		...
		BlockerTests.showBlock(0, b);
		Object pf = new FunctionParser().tryParsing(new Tokenizable(b));
		assertNotNull(pf);
