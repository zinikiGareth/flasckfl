...
import org.flasck.flas.compiler.JSClassCreator;
import org.flasck.flas.compiler.JSExpr;
import org.flasck.flas.compiler.JSGenerator;
import org.flasck.flas.compiler.JSMethodCreator;
import org.flasck.flas.compiler.JSStorage;
...
public class UnitTestGenerationJS {
	...
	public void weVisitAnAssertStep() {
		...
		context.checking(new Expectations() {{
			...
			oneOf(meth).literal("hello"); will(returnValue(ra));
