...
public class TDAStructFieldParsingTests {
	...
	public void aSimpleFieldDefinitionIsAdded() {
		...
		TDAStructFieldParser parser = new TDAStructFieldParser(errors, builder, FieldsType.STRUCT);
	...
	public void junkIsNotPermittedAfterAnAssignment() {
		...
		TDAStructFieldParser parser = new TDAStructFieldParser(tracker, builder, FieldsType.STRUCT);
		TDAParsing nested = parser.tryParsing(toks);
		assertTrue(nested instanceof IgnoreNestedParser);
	}
	...
	public void envelopeFieldsMayNotHaveInitializers() {
		...
		TDAStructFieldParser parser = new TDAStructFieldParser(tracker, builder, FieldsType.ENVELOPE);
		TDAParsing nested = parser.tryParsing(toks);
		assertTrue(nested instanceof IgnoreNestedParser);
	}
	...
	public void wrapsFieldsMustHaveInitializers() {
		...
		TDAStructFieldParser parser = new TDAStructFieldParser(tracker, builder, FieldsType.WRAPS);
		TDAParsing nested = parser.tryParsing(toks);
		assertTrue(nested instanceof IgnoreNestedParser);
	}
}
