...
public class PatternAnalysis {
	...
	public void analyzeFunctionWithNoArguments() {
		...
		new Traverser(hsi).withHSI().visitHSI(vars, "", slots, new FunctionHSICases(fn.intros()), new ArrayList<FunctionIntro>());
	}
	...
	public void analysisWorksForStandaloneMethodsToo() {
		...
		new Traverser(hsi).withHSI().visitHSI(vars, "", slots, new FunctionHSICases(conv), new ArrayList<FunctionIntro>());
	}
